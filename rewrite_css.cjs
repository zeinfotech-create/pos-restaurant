...
const replacement = `
        ...
        .pos-top-nav { height: 100px; padding: 0 3rem; display: flex; align-items: center; border-bottom: 1px solid var(--border); background: var(--bg-surface); width: 100%; z-index: 10;}
