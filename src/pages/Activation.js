          ...
          <div class="login-card-premium">
            ...
            <div style="margin-top: 20px; padding-top: 16px; border-top: 1px solid var(--border); text-align:center">
              <p style="font-size:12px; color:var(--text-muted); margin-bottom:12px">
                Don't have a key yet? <a href="mailto:support@zeinfotech.com" style="color:var(--primary); font-weight:600">Contact Zeinfotech</a>
              </p>
            ...
            <p style="color: #334155; font-size: 11px; margin-top: 24px; text-align:center">© 2026 POS Enterprise v2.4.0</p>
          </div>
        </div>
      </div>
    </div>
