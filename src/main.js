...
async function renderSidebar() {
  ...
  if (!sidebar) return;
    ...
    <nav class="sidebar-nav">
      ...
      ${perms.pos ? `<button class="nav-item ${getCurrentPage().startsWith('kitchen') ? 'active' : ''}" data-page="kitchen"><i class="fa-solid fa-kitchen-set"></i> <span>Kitchen</span></button>` : ''}
      ...
      ` : ''}
      ${perms.inventoryManage ? `
        <button class="nav-item ${getCurrentPage().startsWith('expenses') ? 'active' : ''}" data-page="expenses"><i class="fa-solid fa-receipt"></i> <span>Expenses</span></button>
      ` : ''}
      ...
      ${perms.staff ? `<button class="nav-item ${getCurrentPage().startsWith('attendance') ? 'active' : ''}" data-page="attendance"><i class="fa-solid fa-clock"></i> <span>Attendance</span></button>` : ''}
...
function getPageTitle(page) {
  const titles = {
    ...
    register: 'Register', 'stock-transfer': 'Stock Transfer', expenses: 'Expenses', attendance: 'Staff Attendance',
  };
    ...
    <div class="topbar-notif-wrapper" style="position:relative;">
      ...
      <div id="shortcutsDropdown" class="shortcut-dropdown hidden">
        ...
        <div class="shortcut-grid">
          <div class="shortcut-item" onclick="window.navigate('kitchen')">
...
window.addEventListener('license-status-changed', () => { 
  ...
  const standalonePages = ['login', 'onboarding', 'customer-display', 'quick-pos', 'restaurant-pos', 'kitchen-display', 'kd'];
